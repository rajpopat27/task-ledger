...
// Examples: tl-a3f2dd (6), tl-a3f2dda (7), tl-a3f2dda8 (8)
//
...
// Format: parent.N (e.g., "tl-af78e9a2.1", "tl-af78e9a2.1.2")
//
...
// Examples:
//
//	"tl-af78e9a2" → ("tl-af78e9a2", "", 0)
//	"tl-af78e9a2.1" → ("tl-af78e9a2", "tl-af78e9a2", 1)
//	"tl-af78e9a2.1.2" → ("tl-af78e9a2", "tl-af78e9a2.1", 2)
