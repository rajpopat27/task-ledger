// Package ui provides terminal styling and output helpers for taskledger CLI.
package ui
...
// Can be controlled with TL_NO_EMOJI environment variable.
func ShouldUseEmoji() bool {
	// Explicit disable
	if os.Getenv("TL_NO_EMOJI") != "" {
		return false
	}
