// Package ui provides terminal styling for taskledger CLI output.
...
//   - TL_AGENT_MODE=1 environment variable (explicit)
...
// active review/work, blocked, and pinned states get color; open/closed use standard text
